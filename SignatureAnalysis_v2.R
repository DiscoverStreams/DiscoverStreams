...
for (i in seq_along(huc180102CA_sites)) {
        site_number <- huc180102CA_sites[i]
...
site_number <- huc040500MI_ws$site_no[i=1]
  ...
  colnames(waterUse) <- c("Date", huc040500MI_ws$station_nm[i])
  huc040500MI_wu <- waterUse
