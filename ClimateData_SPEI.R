...
cl_110300KS_SPEI12_hd_df <- data.frame(cl_110300KS_P_PET$DATE, cl_110300KS_SPEI12_hd[["fitted"]])
  colnames(cl_110300KS_SPEI12_hd_df) <- c("DATE", "SPEI-11030001", "SPEI-11030004", "SPEI-11030005", "SPEI-11030008", "SPEI-11030009", "SPEI-11030010", "SPEI-11030011", "SPEI-11030012", "SPEI-11030013", "SPEI-11030016", "SPEI-11030017", "SPEI-11030018")
...
cl_110300KS_SPEI12_long_df <- data.frame(cl_110300KS_P_PET$DATE, cl_110300KS_SPEI12_long[["fitted"]])
  colnames(cl_110300KS_SPEI12_long_df) <- c("DATE", "SPEI-11030001", "SPEI-11030003", "SPEI-11030012", "SPEI-11030013", "SPEI-11030018")
  cl_110300KS_SPEI12_long_df$DATE <- as.Date(cl_110300KS_SPEI12_long_df$DATE)
...
p_cl_110300KS_SPEI12_long_melt <- ggplot2::ggplot(cl_110300KS_SPEI12_long_melt, aes(x = DATE, y = SPEI, group = Watershed, fill = Watershed)) +
  ...
  # scale_y_continuous(breaks = c(-2, -1, 0, 1, 2), labels = c(-2, -1, 0, 1, 2)) +
  theme(axis.title.x = element_text(size = 26), axis.title.y = element_text(size = 26), axis.text = element_text(size = 28), legend.text = element_text(size = 18), legend.title = element_text(size = 18))
p_cl_110300KS_SPEI12_long_melt
